...
# Classement des circo
## Top 10 PS
top10_PS <- voix_expr %>%
  select(voix_expr_2012_PS, voix_expr_2017_PS, voix_expr_2022_PS) %>%
  pivot_longer(
...
## Top 10 LR
top10_LR <- voix_expr %>%
  select(voix_expr_2012_LR, voix_expr_2017_LR, voix_expr_2022_LR) %>%
  pivot_longer(
    cols = starts_with("voix"),
    names_to = "variable",
    values_to = "valeur"
...
vote_PS <- vote_PS %>%
  mutate(
    across(
      c(code_depart, libelle, id_circo, coor1, coor2,
        inscrits2012, exp2012,
        inscrits2017, exp2017,
        inscrits2022, exp2022,
        voix_inscrits_2012, voix_expr_2012,
        voix_inscrits_2017, voix_expr_2017,
        voix_inscrits_2022, voix_expr_2022,
        voix2012, voix2017, voix2022),
      as.character
    )
  )
